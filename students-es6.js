...
class Student {
  ...
  age() { // рассчитываем возраст
    return new Date().getFullYear() - this.yearOfBirth;
  }

  averageGrade() { // рассчитываем средний балл
    let totalGrades = 0;
  ...
  averageAttendance() { // рассчитываем среднее посещение
  ...
  summary() { // проверяет средний балл и среднее посещение
